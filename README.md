...
├── argocd/
│   └── helloworld-prod-application.yaml  # PROD environment Application manifest (auto-synced)
...
### Deploy helloworld-prod essesseff App to Argo CD
...
2. essesseff validates OTP and updates PROD `Chart.yaml` and `values.yaml`
